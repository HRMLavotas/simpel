...
async function fixRuslanRank() {
  console.log('🔧 Memperbaiki rank_group Ruslan Abdul Gani...\n');
  ...
  console.log(`Rank Group    : ${before.rank_group} ❌ (SALAH)`);
  console.log(`Department    : ${before.department}`);
  console.log('');

  // 2. Update rank_group
  console.log('⚙️  Melakukan update...\n');
  ...
  console.log(`Rank Group    : ${updated.rank_group} ✅ (BENAR)`);
...
fixRuslanRank().catch(console.error);
