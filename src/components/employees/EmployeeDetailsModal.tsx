...
import { User, Briefcase, Calendar, MapPin, Award, Building2, GraduationCap, History, FileText } from 'lucide-react';
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-lg">Riwayat Pendidikan</h3>
                  </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-lg">Riwayat Jabatan</h3>
                  </div>
                  <div className="space-y-3">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-lg">Riwayat Kenaikan Pangkat</h3>
                  </div>
                  <div className="space-y-3">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-lg">Riwayat Mutasi</h3>
                  </div>
                  <div className="space-y-3">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-lg">Keterangan Penempatan</h3>
                  </div>
            ...
            {assignmentNotes.length > 0 && (
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    <FileText className="h-5 w-5 text-primary" />
                    <h3 className="font-semibold text-lg">Keterangan Penugasan Tambahan</h3>
                  </div>
                  <div className="space-y-2">
            ...
            {changeNotes.length > 0 && (
              <Card>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    <FileText className="h-5 w-5 text-primary" />
                    <h3 className="font-semibold text-lg">Keterangan Perubahan</h3>
                  </div>
                  <div className="space-y-2">
