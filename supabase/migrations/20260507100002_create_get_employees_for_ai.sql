-- Create function to get employees data for AI chatbot
...
-- Add comment
COMMENT ON FUNCTION public.get_employees_for_ai IS 'Returns employee data for AI chatbot, bypassing RLS';
