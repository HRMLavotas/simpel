-- =============================================
-- Force recreate get_dashboard_stats function
-- Drop and recreate to ensure clean state
-- =============================================

-- Drop existing function (all overloads)
DROP FUNCTION IF EXISTS get_dashboard_stats(TEXT, TEXT[], BOOLEAN);
...
-- Add comment
COMMENT ON FUNCTION get_dashboard_stats(TEXT, TEXT[], BOOLEAN) IS 'Get dashboard statistics with option to include/exclude inactive employees. Default excludes inactive.';
